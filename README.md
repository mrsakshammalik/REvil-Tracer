...
**REvil-Tracer** is an exploiting tool which compiles a malware with famous payload, and then the compiled maware can be executed on Linux , Windows , Mac and Android. **REvil-Tracer** Provides An Easy way to create Backdoors and Payload which can bypass most anti-virus. 
...
```
### Troubleshoot on REvil-Tracer
chk_tools script to use in case of problems in setup.sh of REvil-Tracer
this script will check if everything is in the right version to run REvil-Tracer
